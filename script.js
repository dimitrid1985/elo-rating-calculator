...
async function carregarJogadores() {
    try {
        ...
        // SE NÃO ESTIVER NA PÁGINA DE REGISTRO, ABORTA A FUNÇÃO AQUI
        if (!selectBrancas || !selectPretas) return; 
        ...
        mostrarMensagem('Erro ao carregar a lista de jogadores do servidor.', 'erro');
    }
}


// Lógica de envio do formulário de partida
const formPartida = document.getElementById('formPartida');

if (formPartida) {
    formPartida.addEventListener('submit', async function(event) {
